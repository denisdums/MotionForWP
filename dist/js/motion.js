...
function InViewManager() {
  return {
    ...
    bind: function bind() {
      this.inViewElements = document.querySelectorAll('.motion-in-view-trigger');
    ...
    initInViewListeners: function initInViewListeners() {
      ...
      this.inViewElements.forEach(function (element) {
        (0,motion__WEBPACK_IMPORTED_MODULE_0__.inView)(element, _this.handleInViewEvent);
      });
    },
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/motion.js")))
